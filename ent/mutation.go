...
import (
	...
	"github.com/annoying-orange/ecp-api/ent/predicate"
...
// SetReferrers sets the "referrers" field.
func (m *AccountMutation) SetReferrers(s []string) {
	m.referrers = &s
}

// Referrers returns the value of the "referrers" field in the mutation.
func (m *AccountMutation) Referrers() (r []string, exists bool) {
	v := m.referrers
	if v == nil {
		return
	}
...
// OldReferrers returns the old "referrers" field's value of the Account entity.
// If the Account object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *AccountMutation) OldReferrers(ctx context.Context) (v []string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, fmt.Errorf("OldReferrers is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
		return v, fmt.Errorf("OldReferrers requires an ID field in the mutation")
	}
	oldValue, err := m.oldValue(ctx)
	if err != nil {
		return v, fmt.Errorf("querying old value for OldReferrers: %w", err)
	}
	return oldValue.Referrers, nil
}

// ResetReferrers resets all changes to the "referrers" field.
func (m *AccountMutation) ResetReferrers() {
	m.referrers = nil
}
...
func (m *AccountMutation) Fields() []string {
	...
	if m.referrers != nil {
		fields = append(fields, account.FieldReferrers)
	}
	return fields
}
