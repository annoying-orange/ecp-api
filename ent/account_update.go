...
func (au *AccountUpdate) SetCode(s string) *AccountUpdate {
	au.mutation.SetCode(s)
	return au
}

// SetReferrers sets the "referrers" field.
func (au *AccountUpdate) SetReferrers(s []string) *AccountUpdate {
	au.mutation.SetReferrers(s)
	return au
}
...
func (au *AccountUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := au.mutation.Code(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: account.FieldCode,
		})
	}
	if value, ok := au.mutation.Referrers(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeJSON,
			Value:  value,
			Column: account.FieldReferrers,
		})
	}
...
// SetCode sets the "code" field.
func (auo *AccountUpdateOne) SetCode(s string) *AccountUpdateOne {
	auo.mutation.SetCode(s)
	return auo
}

// SetReferrers sets the "referrers" field.
func (auo *AccountUpdateOne) SetReferrers(s []string) *AccountUpdateOne {
	auo.mutation.SetReferrers(s)
	return auo
}
...
func (auo *AccountUpdateOne) sqlSave(ctx context.Context) (_node *Account, err error) {
	...
	if value, ok := auo.mutation.Referrers(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeJSON,
			Value:  value,
			Column: account.FieldReferrers,
